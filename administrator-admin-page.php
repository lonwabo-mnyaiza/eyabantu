 ...
 */
    ...
    {
        $text = 'View All';
        $query = "SELECT * FROM administrators WHERE Flag = 'Active'";
        $result = mysqli_query($db_conn, $query);
    }
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header">Administrators</h1>
              <a href="administrator-add-page.php?category=administrator" class="btn btn-primary">Add</a>              
              <a href="administrator-admin-page.php?view=<?php echo $text; ?>" class="btn btn-warning"><?php echo $text; ?></a> 
                <a class="btn btn-danger" data-toggle="modal" data-target="#clear-administrator-archive-confirmation">Clear Archive</a> 
...
<!--                     <th>Gender</th>
              ...
              <tbody>
                  <?php 
                  if ($administrator_results != null)
                  {
                  foreach ($administrator_results as $administrator_result)
                  {
                    echo '<tr>';
                    
                    echo '<td>';
                    echo $administrator_result['Title'];
                    echo '</td>';
                    
                    echo '<td>';
                    echo $administrator_result['Name'];
                    echo '</td>';
                    
                    echo '<td>';
                    echo $administrator_result['Surname'];
                    echo '</td>';
                    
//                    echo '<td>';
//                    echo $administrator_result['Gender'];
//                    echo '</td>';
//                    
//                    echo '<td>';
//                    echo $administrator_result['Race'];
//                    echo '</td>';
                    
                    $value = $administrator_result['Email'];
                    echo '<td>';
                    if ($administrator_result['Flag'] == 'Active')
                    {
                        echo '<a href="administrator-delete-page.php?id='.$value.'&amp;category=administrator" class="btn btn-link">Remove</a>';
                    }
                    echo '<a href="administrator-view-details.php?id='.$value.'&amp;category=administrator" class="btn btn-link">View Details</a>';
                    echo '</td>';
      ...
      <form action="php/remove-administrator-archive.php" method="post">
      <div class="modal fade modal-form" id="clear-administrator-archive-confirmation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
                <p>Are you sure you wish to clear all data for administrators?</p>
            </div>            

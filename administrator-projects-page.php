      ...
      <div class="row">
        <div class="col-sm-2 col-md-1 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="administrator-projects-page.php">Projects</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header">Projects</h1>          
              <a href="administrator-add-page.php?category=project" class="btn btn-primary">Add</a>
            ...
            <table class="table table-responsive table-hover">
              ...
              <tbody>
                  ...
                  foreach ($project_results as $project_result)
                  {
                    ...
                    $value = $project_result['CompanyID'];
                    echo '<td>';
                    
                    echo '<a class="btn btn-link"><input type="file" value="Quote"/></a>';
                    echo '<a  href="administrator-change-page.php?id='.$value.'&amp;category=project"class="btn btn-link">Send Quote</a>';
                    echo '<a  href="administrator-change-page.php?id='.$value.'&amp;category=project"class="btn btn-link">Change</a>';
                    echo ' <a href="administrator-delete-page.php?id='.$value.'&amp;category=project" class="btn btn-link">Remove</a>';
                    echo '<a class="btn btn-link">View Details</a>';                    
                    echo '</td>'; 

 ...
 */
    ...
    {
        $text = 'View All'; 
        $query = "SELECT * FROM subscribers WHERE Flag = 'Active'";
        $result = mysqli_query($db_conn, $query);
    }
...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-2 col-md-1 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="administrator-subscribers-page.php">Subscribers</a></li>             
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header">Subscribers</h1>          
              <button class="btn btn-info">Send Notifications</button>   
                <a href="administrator-subscribers-page.php?view=<?php echo $text; ?>" class="btn btn-warning"><?php echo $text; ?></a> 
                <a class="btn btn-warning" data-toggle="modal" data-target="#remove-subscriber-archive-confirmation">Remove All</a> 
                <a class="btn btn-danger" data-toggle="modal" data-target="#clear-subscriber-archive-confirmation">Clear Archive</a> 
              ...
              <tbody>
                  ...
                  if ($subscribers_results != null)
                  {
                    foreach ($subscribers_results as $subscribers_result)
                    {
                      ...
                      $value = $subscribers_result['Email'];
                      echo '<td>';
                      
                      if ($subscribers_result['Flag'] == 'Active')
                      {
                          echo '<a href="administrator-delete-page.php?id='.$value.'&amp;category=subscriber" class="btn btn-link">Remove</a>'; 
                      }
                      echo '<a href="administrator-view-details.php?id='.$value.'&amp;category=subscriber" class="btn btn-link">View Details</a>';
                      echo '</td>';
    ...
    <form action="php/remove-subscriber-all.php" method="post">
      <div class="modal fade modal-form" id="remove-subscriber-archive-confirmation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
                <p>Are you sure you wish to remove all data for subscribers?</p>
            </div>            
    ...
    <form action="php/remove-subscriber-archive.php" method="post">
      <div class="modal fade modal-form" id="clear-subscriber-archive-confirmation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
                <p>Are you sure you wish to clear all data for subscribers?</p>
            </div>            
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
            <button name="article_submit" type="submit" class="btn btn-danger">Yes</button>

 ...
 */
    ...
    {
        $text = 'View All'; 
        $query = "SELECT * FROM technicians WHERE Flag = 'Active'";
        $result = mysqli_query($db_conn, $query);
    }
    
    if (mysqli_affected_rows($db_conn) > 0)
    {
        $technician_results = mysqli_fetch_all($result, MYSQLI_ASSOC);
        mysqli_free_result($result);
    }
    else 
    {
        $technician_results = null;
    }
      ...
      <div class="row">
        <div class="col-sm-2 col-md-1 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="administrator-technicians-page.php">Technicians</a></li>            
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header">Technicians</h1>
              <a href="administrator-add-page.php?category=technician" class="btn btn-primary">Add</a>              
               <a href="administrator-technicians-page.php?view=<?php echo $text; ?>" class="btn btn-warning"><?php echo $text; ?></a>  
               <a class="btn btn-danger" data-toggle="modal" data-target="#clear-technician-archive-confirmation">Clear Archive</a> 
...
<!--                     <th>Gender</th>
              ...
              <tbody>
                  ...
                  foreach ($technician_results as $technician_result)
                  {
                    ...
                    echo '<td>';
                    echo $technician_result['Title'];
                    echo '</td>';
                    
                    echo '<td>';
                    echo $technician_result['Name'];
                    echo '</td>';
                    
                    echo '<td>';
                    echo $technician_result['Surname'];
                    echo '</td>';
                    
                    $value = $technician_result['Email'];
                    echo '<td>';
                    echo '<a href="administrator-change-page.php?id='.$value.'&amp;category=technician" class="btn btn-link">Update</a>'; 
                    if ($technician_result['Flag'] == 'Active')
                    {
                        echo '<a href="administrator-delete-page.php?id='.$value.'&amp;category=technician" class="btn btn-link">Remove</a>';
                    }
                    echo '<a href="administrator-view-details.php?id='.$value.'&amp;category=technician" class="btn btn-link">View Details</a>';
                    echo '</td>';
      ...
      <form action="php/remove-technician-archive.php" method="post">
      <div class="modal fade modal-form" id="clear-technician-archive-confirmation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
                <p>Are you sure you wish to clear all data for technicians?</p>
            </div>            

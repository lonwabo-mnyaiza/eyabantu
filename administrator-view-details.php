 ...
 */
    ...
    function loadAdministrators()
    {
       ...
       else 
       {
        ...
        echo '<h1 class="page-header">Administrator Details</h1>';
        ...
        echo '</tr>';
        echo '</table>';
        echo        '<a href="administrator-admin-page.php" class="btn btn-primary">Back</a>';           
        echo '</div>';
    }
    ...
    function loadArticles()
    {
        ...
        echo '<h1 class="page-header">Article Details</h1>';
        echo  '<div class="featurette">';                
        echo      '<table class="table table-responsive table-hover table-bordered">';
        echo '<tr>';
        echo    '<td>Title</td>';
        ...
        echo '</tr>';
        echo '</table>';
        echo        '<a href="administrator-articles-page.php" class="btn btn-primary">Back</a>';             
        echo '</div>';
    } 
    ...
    {    
        ...
        echo '<h1 class="page-header">Event Details</h1>';
        echo  '<div class="featurette">';         
        echo        '<table class="table table-responsive table-hover table-bordered">';
        echo             '<tr>';
        echo                  '<td>Title</td>';
        echo                  '<td>'.$event_results['Title'].'</td>';
        echo            '</tr>';
        echo            '<tr>';
        echo                   '<td>Description</td>';
        echo                   '<td>'.$event_results['Description'].'</td>';
        echo            '</tr>';
        echo            '<tr>';
        echo                  '<td>URL</td>';
        echo                  '<td>'.$event_results['URL'].'</td>';
        echo          '</tr>';
        echo            '<tr>';
        echo                  '<td>Image File</td>';
        echo                  '<td>'.$event_results['ImageFile'].'</td>';
        echo          '</tr>';
        echo      '</table>';
        echo        '<a href="administrator-events-page.php" class="btn btn-primary">Back</a>';        
        echo '</div>';  
    }
    ...
    function loadBusinessMembers()    
    {
        ...
        echo '<h1 class="page-header">View Business Member</h1>';
        echo  '<div class="featurette">';       
        echo      '<table class="table table-responsive table-hover table-bordered">';
        echo '<tr>';
        echo    '<td>Company</td>';
        ...
        echo        '<a href="administrator-members-page.php" class="btn btn-primary">Back</a>';  
    ...
    function loadIndividualMembers()    
    {
        ...
        echo '<h1 class="page-header">View Individual Member</h1>';
        echo  '<div class="featurette">';        
        echo      '<table class="table table-responsive table-hover table-bordered">';
        echo '<tr>';
        echo    '<td>Title</td>';
    ...
    function loadMessages()
    {
        ...
        echo '<h1 class="page-header">Message Details</h1>';
        echo  '<div class="featurette">';                
        echo      '<table class="table table-responsive table-hover table-bordered">';
        echo '<tr>';
        echo    '<td>Name</td>';
        ...
        echo '</tr>';
        echo '</table>';
        echo        '<a href="administrator-messages-page.php" class="btn btn-primary">Back</a>';          
        echo '</div>';
    }     
    ...
    function loadServices()
    {
        ...
        echo '<h1 class="page-header">Service Details</h1>';
        echo  '<div class="featurette">';                
        echo      '<table class="table table-responsive table-hover table-bordered">';
        echo '<tr>';
        echo    '<td>Name</td>';
        ...
        echo '</tr>'; 
        echo '</table>';
        echo        '<a href="administrator-services-page.php" class="btn btn-primary">Back</a>';          
        echo '</div>';
    } 
    ...
    function loadSubscribers()
    {
        ...
        echo '<h1 class="page-header">Subscriber Details</h1>';
        echo  '<div class="featurette">';        
        echo      '<table class="table table-responsive table-hover table-bordered">';
        echo '<tr>';
        echo    '<td>Name</td>';
        ...
        echo '</tr>';
         echo '<tr>';
        echo    '<td>Date Subscribed</td>';
        echo    '<td>'. $change_values[3].'</td>';
        echo '</tr>';
        echo '<tr>';
        echo    '<td>Date Unsubscribed</td>';
                if ($change_values[4] == null)
                {
                    echo    '<td>N/A</td>';
                }
                else 
        ...
        echo '</tr>';
        echo '</table>';
        echo        '<a href="administrator-subscribers-page.php" class="btn btn-primary">Back</a>';         
        echo '</div>';
    }
    ...
    function loadTechnicians()
    {
       ...
       {           
        ...
        echo '<h1 class="page-header">Technician Details</h1>';
        echo  '<div class="featurette">';               
        echo      '<table class="table table-responsive table-hover table-bordered">';
        echo '<tr>';
        echo    '<td>Title</td>';
        ...
        echo '</tr>';
        echo '</table>';
        echo        '<a href="administrator-technicians-page.php" class="btn btn-primary">Back</a>';           
        echo '</div>';
    }

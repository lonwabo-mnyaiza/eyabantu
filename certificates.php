...
<!--        <style type="text/css">
        ...
        <title>Eya Bantu Certificates</title>
    </head>
    <body>
    ...
    <div class="container marketing">
        ...
        <h2 class="featurette-heading">BBBEE <span class="muted"> Certificate.</span></h2>
        <p class="lead">
            Eya Bantu is a BBBEE Level 4 company 
        </p>
      </div>
        <hr class="featurette-divider">

        <div class="featurette">        
        <h2 class="featurette-heading">Professional<span class="muted"> Registration.</span></h2>
        <p class="lead">
            Eya Bantu is accredited with ECSA. Click here to search our accredited Engineers.
        </p>
        <img src="img/ecsa.png" alt="about us image">
      </div>
        <hr class="featurette-divider">
    </div>
        <!-- FOOTER -->

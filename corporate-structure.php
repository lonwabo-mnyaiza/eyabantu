...
<!--        <style type="text/css">
    ...
    <div class="container marketing">        
        ...
        <h2 class="featurette-heading">Eya Bantu - <span class="muted">East London.</span></h2>
        <div class="row">
            
        <div class="span4">
          <img class="img-circle" src="img/staff/Mbuso-Gqadu.jpg" data-src="holder.js/140x140">
          <h2>Mbuso Gqadu</h2>
          <p>Field Services</p>       
        </div> <!--/.span4 -->
        
        <div class="span4">
            <img class="img-circle" src="img/staff/Mike-Brown.jpg" data-src="holder.js/140x140">
          <h2>Mike Brown</h2>
          <p>Consulting & International Projects</p>          
        </div><!-- /.span4 -->
        
        <div class="span4">
          <img class="img-circle" src="img/staff/Craig-Powell.jpg" data-src="holder.js/140x140">
          <h2>Craig Powell</h2>
          <p>Engineering Services</p>          
        </div><!-- /.span4 -->
        
        <div class="span4">
          <img class="img-circle" src="img/staff/Mzwabantu-Pambaniso.jpg" data-src="holder.js/140x140">
          <h2>Mzwabantu Pambaniso</h2>
          <p>Power System Studies</p>       
        </div> <!--/.span4 -->
        
        <div class="span4">
            <img class="img-circle" src="img/staff/Terry-Lee.jpg" data-src="holder.js/140x140">
          <h2>Terry Lee</h2>
          <p>Renewable Power & Energy Efficiency</p>          
        </div><!-- /.span4 -->
        
        <div class="span4">
          <img class="img-circle" src="img/staff/Ndimphiwe-Mapuko.jpg" data-src="holder.js/140x140">
          <h2>Ndimphiwe Mapuko</h2>
          <p>Electrification</p>          
        </div><!-- /.span4 -->
        
        <div class="span4">
          <img class="img-circle" src="img/staff/Naas-Burger.jpg" data-src="holder.js/140x140">
          <h2>Naas Burger</h2>
          <p>Design & Engineering</p>       
        </div> <!--/.span4 -->
        
        <div class="span4">
            <img class="img-circle" src="img/staff/Steve-Crossman.jpg" data-src="holder.js/140x140">
          <h2>Steve Crossman</h2>
          <p>Survey & Data Capture</p>          
        </div><!-- /.span4 -->
        
        <div class="span4">
          <img class="img-circle" src="img/staff/Dennis-Trethewey.jpg" data-src="holder.js/140x140">
          <h2>Dennis Trethewey</h2>
          <p>Site Management</p>          
        </div><!-- /.span4 -->
        
        <div class="span4">
          <img class="img-circle" src="img/staff/Jeff-Richter.jpg" data-src="holder.js/140x140">
          <h2>Jeff Richter</h2>

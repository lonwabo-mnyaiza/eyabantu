<?php
    ...
    function loadUnsuccessfulMemberUpdate()
    {
        echo '<div class="row">';
        echo '<div class="col-6 col-sm-6 col-lg-4">';                
        echo '<h3 class="h3">Sorry your request to update your profile could not be processed at this moment, try again after a moment if problem persists please feel free to contact us directly.</h3>';
        echo '</div>';
        echo '</div>';
    }

 ...
 */
    ...
    function loadInvalidUser()
    {
          ...
          echo '<h2 class="featurette-heading">Eya Bantu<span class="muted"> your partner in power.</span></h2>';        
          echo '<h3 class="h3">Invalid username or password<h3>';
          echo  '</div>';            
          echo  '<hr class="featurette-divider">';
          echo  '</div>';
    }
    
    function loadUnsuccessfulContact()
    {
        echo '<div class="container marketing">';
          echo  '<hr class="featurette-divider">';
          echo  '<div class="featurette">';
          echo '<h2 class="featurette-heading">Eya Bantu<span class="muted"> your partner in power.</span></h2>';        
          echo '<h3 class="h3">Sorry your message could not be processed, try again after a moment if problem persists please feel free to contact us directly.<h3>';
          echo  '</div>';            
          echo  '<hr class="featurette-divider">';
          echo  '</div>';
    }
    ...
    function loadUnsuccessfulSubscriber()
    {
         echo '<div class="container marketing">';
          ...
          echo  '<div class="featurette">';
          echo '<h2 class="featurette-heading">Eya Bantu<span class="muted"> your partner in power.</span></h2>';        
          echo '<h3 class="h3">Sorry your request to subscribe could not be processed, try again after a moment if problem persists please feel free to contact us directly.<h3>';
          echo  '</div>';            
          echo  '<hr class="featurette-divider">';
          echo  '</div>';
    }
    function loadUnsuccessfulMember()
    {
         echo '<div class="container marketing">';
          ...
          echo  '<div class="featurette">';
          echo '<h2 class="featurette-heading">Eya Bantu<span class="muted"> your partner in power.</span></h2>';        
          echo '<h3 class="h3">Sorry your request to become a member could not be processed, try again after a moment if problem persists please feel free to contact us directly.<h3>';
          echo  '</div>';            
          echo  '<hr class="featurette-divider">';
          echo  '</div>';
    }
    function loadUnsuccessfulSearch()
    {
         echo '<div class="container marketing">';
          ...
          echo  '<div class="featurette">';
          echo '<h2 class="featurette-heading">Eya Bantu<span class="muted"> your partner in power.</span></h2>';        
          echo '<h3 class="h3">No results found or your search could not be processed at this time, try again after a moment if problem persists please feel free to contact us directly.<h3>';
          echo  '</div>';            
          echo  '<hr class="featurette-divider">';
          echo  '</div>';
    }
...
<html>
    ...
    <body>
      ...
      <?php
        if ($category == 'Invalid User')
        { loadInvalidUser(); }
        if ($category == 'Contact')
        { loadUnsuccessfulContact(); }

                ...
                <div>
                    ...
                    <div class="control-group">                        
                        <div class="controls controls-row">
                            <input type="text" placeholder="First Name *" name="name" maxlength="50" required="true" />
                            <input type="text" placeholder="Last Name *" name="surname" maxlength="50" required="true" />
                        </div>                        
                        <input type="text" placeholder="Company Name *" name="company_name" maxlength="100" required="true" />                        
                        <input type="text" placeholder="Website URL" name="company_url" maxlength="100" />
                        <!--<span><?php echo $websiteErr; ?></span>-->
                        <div class="controls controls-row">
                            <input type="email" placeholder="Email *" name="email" maxlength="100" required="true" />
                            <input type="tel" placeholder="Phone Number *" name="phone_number" maxlength="100" required="true" />
                        </div>
                        ...
                        <textarea maxlength="500" rows="6" placeholder="Tell us more about your project / additional comments *" name="project_details" ></textarea>
                            <div class="controls controls-row">

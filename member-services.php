<?php
    ...
    require_once 'php/get_service_desc.php'; 
?>
<!DOCTYPE html>
<!--
        ...
        <div class="col-xs-12 col-sm-9">
           ...
           <?php
            foreach ($services as $service)
            {
                ...
                echo '<tr><th>';                                
                echo '<a style="text-decoration:none; color:#5A5A5A;" href="member-service-desc.php?service_value='.$service['Value'].'">';
                echo $service['Name'];
                echo '</a>';
                echo '</th></tr>';
                echo '<tr><td>';
                echo substr($service['Description'], 0, 200) . '...';
                echo '</td></tr>'; 
                echo '</table>';
            }
        ?>          

...
<!--        <style type="text/css">
        ...
        <title>Eya Bantu Overview</title>
    </head>
    <body>
    ...
    <div class="container marketing">        
        ...
        <h2 class="featurette-heading">Corporate<span class="muted"> Overview.</span></h2>
        <p class="lead">
            Eya Bantu – your Partner in power - Eya Bantu, established in 1999, is a South African based premium consulting company,
            providing consulting services in the Energy sector. We offer a comprehensive range of tailored consultancy 
            solutions including Project Management, Renewable Energy, Engineering and Design, Power System Studies, Tendering,
            Construction Supervision and Advisory Services like Energy Policies, Audits and Due Diligence. Established on the core
            values of professionalism, commitment, integrity and excellence, Eya Bantu believes in delivering customized and value-added
            engineering solutions to its quality-conscious customers. We are also one of the largest service providers of secondary plant
            testing and commissioning in South Africa up to 132kV equipment. We back up our service delivery with a round the clock emergency
            call out facility for fault finding and emergency repairs. Our other field services include transformer oil testing, substation
            maintenance, cabling, thermal imaging and surveying. Our field services teams consist of highly skilled and specialized personnel,
            equipped with the highest quality tools and applying latest technologies and techniques to complete the work safely and on time.
            ...
            accrued from experience in diversified project environments, Eya Bantu recognizes the potential to expand its operations into
            other areas of South Africa. Its business strategy underlines the importance of setting up regional business hubs to work in
            close liaison with the local customers and make them a part of the business process. Eya Bantu is a B-BBEE status
            company and has a CIDB rating of 5EP. Our multi-cultural work force comprises of highly qualified, experienced and committed engineers
            of various specializations. In addition to our permanent staff members, we employ a variety of freelance specialist and local experts in
            our project offices. We aim to offer all the manpower and technological functions to fulfill the requirements of our communities and
            commercial, industrial and corporate clients, while maintaining the highest standards of design and workmanship in order to meet their
            needs and expectations. Our mission is to try to uplift, develop and empower our local communities, businesses and other organizations
            by means of sincere meaningful dedication to their needs. An achievement that we are very proud of was receiving the Certificate of Recognition
            from Eskom in 2003 for our contribution to customer service. We invite you to contact us for further details of our company,
            services and references. We are your partner in power.
        </p>
      </div>

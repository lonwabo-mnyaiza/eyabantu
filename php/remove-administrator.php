 ...
 */
    ...
    $query = "UPDATE administrators SET Title = '$title', Name = '$name', Surname = '$surname', Gender = '$gender', Race = '$race', PhoneNumber = '$phoneNumber', Email = '$email', IDNumber = '$idNumber', DateOfBirth = '$DOB', Password = '$password', Flag = '$flag' " .
            "WHERE Email = '$email'";
